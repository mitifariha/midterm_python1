...
counter = Ticket_Counter(h1)

run = True
while run:
    print("\n1. View all shows")
    print("2. View available")
    ...
    if choice == "1":
        ...
        counter.view_available_seats_in_show(id)

    elif choice == "3":
        show_id = input("Enter the show ID: ")
        seat_list = eval(input("Enter the seat Numer(For Example [(0, 1)]) : "))
        counter.book_tickets(show_id, seat_list)
    elif choice == "4":
        print("Exiting")
        run = False
        break
